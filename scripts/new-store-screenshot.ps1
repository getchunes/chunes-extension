...
try {
    ...
    $Graphics.FillEllipse($PurpleBrush, -170, -250, 600, 600)
    $Graphics.FillEllipse((New-Object Drawing.SolidBrush([Drawing.Color]::FromArgb(22, 88, 101, 242))), 940, 570, 420, 420)

    $Graphics.DrawImage($Icon, 74, 72, 70, 70)
    $Graphics.DrawString("CHUNE ID", $LabelFont, $PurpleBrush, 158, 96)
    $Graphics.DrawString("Music presence,`nproperly identified.", $TitleFont, $InkBrush, 74, 183)
    $Graphics.DrawString("A local browser companion for Chunes desktop.", $SubtitleFont, $MutedBrush, 78, 302)

    $Features = @(
        "SoundCloud and YouTube Music publish controls",
    ...
    $Graphics.FillRectangle($ShadowBrush, 790, 90, 400, 620)
    $Graphics.FillRectangle($WhiteBrush, 780, 80, 400, 620)
